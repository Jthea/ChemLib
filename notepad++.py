# (c) 2024 Thea Amor Arceno
# This program is an interactive Chemical and Gene search engine in command propmt.
...
def search_human_gene():
	...
	try:
		response = requests.get(https://github.com/Jthea/ChemLib.git)
		dataset = json.loads(response.text)
	except Exception as e:	
		print(f"[red]Error:[/red][white]: {e}[/white]")
		return input("\nHit ENTER to return to main menu...")
